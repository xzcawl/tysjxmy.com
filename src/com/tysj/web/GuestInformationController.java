...
public class GuestInformationController {
    ...
    @ResponseBody
    public BasicResult deleteGuestInformation(@RequestBody @Valid GuestInformation appDomainDto) {
        logger.info("@deleteGuestInformation params ：{}", JsonUtil.objToStr(appDomainDto));
        return guestOpreationService.deleteGuestInformation(appDomainDto);
    }
